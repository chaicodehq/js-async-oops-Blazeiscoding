...
export class Batsman extends Player {
  ...
  getStrikeRate() {
    ...
    return this.innings.reduce((sum, innings) => sum + innings.strikeRate, 0) / this.innings.length;
  }
...
export class Bowler extends Player {
  ...
  getEconomy() {
    ...
    return this.spells.reduce((sum, spell) => sum + spell.economy, 0) / this.spells.length;
  }
